...
module.exports = {
    entry: './src/PacMan.ts', //entry point of application
    ...
    output: {
        filename: 'PacMan.js', //name of the final bundled JS file
        path: path.resolve(__dirname, 'out') //put bundled file in this folder
    },
    devtool: 'source-map', //enable source-map for debugging (stepping through). generates WebGLAnimation.js.map
};
